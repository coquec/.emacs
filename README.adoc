...
| Muestra en un nuevo buffer el resultado de expandir la macro que termina en
  el paréntesis que hay antes del cursor.  Precedido de `C-u`, inserta el
  resultado en el buffer actual.
